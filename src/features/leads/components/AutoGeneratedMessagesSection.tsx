  ...
  return (
    <div className="space-y-4 pt-2">
      ...
      {autoMessages.map((autoMsg) => {
        ...
        const messagesByChannel: Record<string, AISuggestion[]> = {
          WhatsApp: [],
          Email: [],
        };

        for (const suggestion of autoMsg.suggestions) {
          if (messagesByChannel[suggestion.type]) {
            messagesByChannel[suggestion.type].push(suggestion);
          }
        }
